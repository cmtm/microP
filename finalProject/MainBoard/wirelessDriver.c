	...
	uint8_t comrade_data[RF2500_PACKET_LENGTH+3];
...
//        RF2500_Strobe(CCxxx0_SIDLE);
    ...
    */
    ...
    {
		w_buff[0] = CommandRegister|READWRITE_CMD;
    ...
    */
    int receiveAccelData(uint8_t* accData)
    {
        ...
        //{
			...
			RF2500_Read(comrade_data, CCxxx0_RXFIFO, RF2500_PACKET_LENGTH + 3);		
